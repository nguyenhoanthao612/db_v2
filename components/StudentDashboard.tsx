                              ...
                              <div className="space-y-2">
                                ...
                                >
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[10px] text-slate-500 mt-0.5 leading-relaxed truncate">
                                      {blockedModes.testing ? 'Giáo viên đã khóa chế độ này.' : `Giới hạn ${exam.Duration || (exam.QuestionIDs?.length > 100 ? 70 : 50)} phút. Chỉ chấm điểm và xem giải thích khi xong.`}
                                    </p>
                                  </div>
                                </button>
